...
entity int4_decoder_token_controller_linear_stage0_RAM_2P_URAM_1R1W is 
    generic(
        MEM_TYPE        : string    := "hls_ultra"; 
        DataWidth       : integer   := 512; 
        AddressWidth    : integer   := 9;
        AddressRange    : integer   := 504
    ); 
    port (
...
architecture rtl of int4_decoder_token_controller_linear_stage0_RAM_2P_URAM_1R1W is 
