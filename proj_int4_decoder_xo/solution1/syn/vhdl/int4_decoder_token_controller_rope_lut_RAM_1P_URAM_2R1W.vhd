...
entity int4_decoder_token_controller_rope_lut_RAM_1P_URAM_2R1W is 
    generic(
        MEM_TYPE        : string    := "hls_ultra"; 
        DataWidth       : integer   := 608; 
...
architecture rtl of int4_decoder_token_controller_rope_lut_RAM_1P_URAM_2R1W is 
