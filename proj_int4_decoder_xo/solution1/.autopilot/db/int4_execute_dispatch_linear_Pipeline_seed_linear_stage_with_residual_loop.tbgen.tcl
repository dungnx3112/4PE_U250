set moduleName int4_execute_dispatch_linear_Pipeline_seed_linear_stage_with_residual_loop
set isTopModule 0
...
set C_modelName {int4_execute_dispatch_linear_Pipeline_seed_linear_stage_with_residual_loop}
set C_modelType { void 0 }
set C_modelArgList {
	{ residual_pe0 int 512 regular {array 64 { 1 3 } 1 1 }  }
	{ linear_stage0 int 512 regular {array 504 { 3 0 } 0 1 }  }
	{ residual_pe1 int 512 regular {array 64 { 1 3 } 1 1 }  }
	{ linear_stage1 int 512 regular {array 504 { 3 0 } 0 1 }  }
	{ residual_pe2 int 512 regular {array 64 { 1 3 } 1 1 }  }
	{ linear_stage2 int 512 regular {array 504 { 3 0 } 0 1 }  }
	{ residual_pe3 int 512 regular {array 64 { 1 3 } 1 1 }  }
	{ linear_stage3 int 512 regular {array 504 { 3 0 } 0 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "residual_pe0", "interface" : "memory", "bitwidth" : 512, "direction" : "READONLY"} , 
 	{ "Name" : "linear_stage0", "interface" : "memory", "bitwidth" : 512, "direction" : "WRITEONLY"} , 
 	{ "Name" : "residual_pe1", "interface" : "memory", "bitwidth" : 512, "direction" : "READONLY"} , 
 	{ "Name" : "linear_stage1", "interface" : "memory", "bitwidth" : 512, "direction" : "WRITEONLY"} , 
 	{ "Name" : "residual_pe2", "interface" : "memory", "bitwidth" : 512, "direction" : "READONLY"} , 
 	{ "Name" : "linear_stage2", "interface" : "memory", "bitwidth" : 512, "direction" : "WRITEONLY"} , 
 	{ "Name" : "residual_pe3", "interface" : "memory", "bitwidth" : 512, "direction" : "READONLY"} , 
 	{ "Name" : "linear_stage3", "interface" : "memory", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ residual_pe0_address0 sc_out sc_lv 6 signal 0 } 
	{ residual_pe0_ce0 sc_out sc_logic 1 signal 0 } 
	{ residual_pe0_q0 sc_in sc_lv 512 signal 0 } 
	{ linear_stage0_address1 sc_out sc_lv 9 signal 1 } 
	{ linear_stage0_ce1 sc_out sc_logic 1 signal 1 } 
	{ linear_stage0_we1 sc_out sc_logic 1 signal 1 } 
	{ linear_stage0_d1 sc_out sc_lv 512 signal 1 } 
	{ residual_pe1_address0 sc_out sc_lv 6 signal 2 } 
	{ residual_pe1_ce0 sc_out sc_logic 1 signal 2 } 
	{ residual_pe1_q0 sc_in sc_lv 512 signal 2 } 
	{ linear_stage1_address1 sc_out sc_lv 9 signal 3 } 
	{ linear_stage1_ce1 sc_out sc_logic 1 signal 3 } 
	{ linear_stage1_we1 sc_out sc_logic 1 signal 3 } 
	{ linear_stage1_d1 sc_out sc_lv 512 signal 3 } 
	{ residual_pe2_address0 sc_out sc_lv 6 signal 4 } 
	{ residual_pe2_ce0 sc_out sc_logic 1 signal 4 } 
	{ residual_pe2_q0 sc_in sc_lv 512 signal 4 } 
	{ linear_stage2_address1 sc_out sc_lv 9 signal 5 } 
	{ linear_stage2_ce1 sc_out sc_logic 1 signal 5 } 
	{ linear_stage2_we1 sc_out sc_logic 1 signal 5 } 
	{ linear_stage2_d1 sc_out sc_lv 512 signal 5 } 
	{ residual_pe3_address0 sc_out sc_lv 6 signal 6 } 
	{ residual_pe3_ce0 sc_out sc_logic 1 signal 6 } 
	{ residual_pe3_q0 sc_in sc_lv 512 signal 6 } 
	{ linear_stage3_address1 sc_out sc_lv 9 signal 7 } 
	{ linear_stage3_ce1 sc_out sc_logic 1 signal 7 } 
	{ linear_stage3_we1 sc_out sc_logic 1 signal 7 } 
	{ linear_stage3_d1 sc_out sc_lv 512 signal 7 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	residual_pe0 { ap_memory {  { residual_pe0_address0 mem_address 1 6 }  { residual_pe0_ce0 mem_ce 1 1 }  { residual_pe0_q0 mem_dout 0 512 } } }
	linear_stage0 { ap_memory {  { linear_stage0_address1 MemPortADDR2 1 9 }  { linear_stage0_ce1 MemPortCE2 1 1 }  { linear_stage0_we1 MemPortWE2 1 1 }  { linear_stage0_d1 MemPortDIN2 1 512 } } }
	residual_pe1 { ap_memory {  { residual_pe1_address0 mem_address 1 6 }  { residual_pe1_ce0 mem_ce 1 1 }  { residual_pe1_q0 mem_dout 0 512 } } }
	linear_stage1 { ap_memory {  { linear_stage1_address1 MemPortADDR2 1 9 }  { linear_stage1_ce1 MemPortCE2 1 1 }  { linear_stage1_we1 MemPortWE2 1 1 }  { linear_stage1_d1 MemPortDIN2 1 512 } } }
	residual_pe2 { ap_memory {  { residual_pe2_address0 mem_address 1 6 }  { residual_pe2_ce0 mem_ce 1 1 }  { residual_pe2_q0 mem_dout 0 512 } } }
	linear_stage2 { ap_memory {  { linear_stage2_address1 MemPortADDR2 1 9 }  { linear_stage2_ce1 MemPortCE2 1 1 }  { linear_stage2_we1 MemPortWE2 1 1 }  { linear_stage2_d1 MemPortDIN2 1 512 } } }
	residual_pe3 { ap_memory {  { residual_pe3_address0 mem_address 1 6 }  { residual_pe3_ce0 mem_ce 1 1 }  { residual_pe3_q0 mem_dout 0 512 } } }
	linear_stage3 { ap_memory {  { linear_stage3_address1 MemPortADDR2 1 9 }  { linear_stage3_ce1 MemPortCE2 1 1 }  { linear_stage3_we1 MemPortWE2 1 1 }  { linear_stage3_d1 MemPortDIN2 1 512 } } }
}
