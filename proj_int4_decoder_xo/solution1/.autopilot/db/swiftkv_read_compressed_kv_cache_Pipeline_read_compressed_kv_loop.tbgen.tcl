set moduleName swiftkv_read_compressed_kv_cache_Pipeline_read_compressed_kv_loop
set isTopModule 0
...
set C_modelName {swiftkv_read_compressed_kv_cache_Pipeline_read_compressed_kv_loop}
set C_modelType { void 0 }
set C_modelArgList {
	{ cached_words int 15 regular  }
	{ gmem0 int 512 regular {axi_master 0}  }
	{ sext_ln681 int 58 regular  }
	{ cached_kv_word_stream int 512 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "cached_words", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sext_ln681", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "cached_kv_word_stream", "interface" : "fifo", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ m_axi_gmem0_RFIFONUM sc_in sc_lv 12 signal 1 } 
	...
	{ cached_kv_word_stream_din sc_out sc_lv 512 signal 3 } 
	{ cached_kv_word_stream_num_data_valid sc_in sc_lv 7 signal 3 } 
	{ cached_kv_word_stream_fifo_cap sc_in sc_lv 7 signal 3 } 
	{ cached_kv_word_stream_full_n sc_in sc_logic 1 signal 3 } 
	{ cached_kv_word_stream_write sc_out sc_logic 1 signal 3 } 
	{ cached_words sc_in sc_lv 15 signal 0 } 
	{ sext_ln681 sc_in sc_lv 58 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "cached_kv_word_stream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "cached_kv_word_stream", "role": "din" }} , 
 	...
 	{ "name": "cached_kv_word_stream_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "cached_kv_word_stream", "role": "full_n" }} , 
 	{ "name": "cached_kv_word_stream_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "cached_kv_word_stream", "role": "write" }} , 
 	{ "name": "cached_words", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "cached_words", "role": "default" }} , 
 	{ "name": "sext_ln681", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln681", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2", "Max" : "20478"}
	, {"Name" : "Interval", "Min" : "2", "Max" : "20478"}
]}
...
set Spec2ImplPortList { 
	cached_words { ap_none {  { cached_words in_data 0 15 } } }
	...
	sext_ln681 { ap_none {  { sext_ln681 in_data 0 58 } } }
	cached_kv_word_stream { ap_fifo {  { cached_kv_word_stream_din fifo_data_in 1 512 }  { cached_kv_word_stream_num_data_valid fifo_status_num_data_valid 0 7 }  { cached_kv_word_stream_fifo_cap fifo_update 0 7 }  { cached_kv_word_stream_full_n fifo_status 0 1 }  { cached_kv_word_stream_write fifo_port_we 1 1 } } }
}
