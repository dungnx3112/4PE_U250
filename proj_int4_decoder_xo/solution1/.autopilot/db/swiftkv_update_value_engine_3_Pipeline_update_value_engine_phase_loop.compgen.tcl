...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { engine3_phase_stream_dout { I 57 vector } engine3_phase_stream_num_data_valid { I 4 vector } engine3_phase_stream_fifo_cap { I 4 vector } engine3_phase_stream_empty_n { I 1 bit } engine3_phase_stream_read { O 1 bit } } \
} "
}
