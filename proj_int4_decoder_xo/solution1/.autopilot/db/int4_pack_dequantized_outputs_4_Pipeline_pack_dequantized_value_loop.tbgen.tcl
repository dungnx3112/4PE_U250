set moduleName int4_pack_dequantized_outputs_4_Pipeline_pack_dequantized_value_loop
set isTopModule 0
...
set C_modelName {int4_pack_dequantized_outputs.4_Pipeline_pack_dequantized_value_loop}
