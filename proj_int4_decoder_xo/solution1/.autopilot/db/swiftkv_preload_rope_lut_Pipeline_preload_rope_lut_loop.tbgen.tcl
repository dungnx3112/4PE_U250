set moduleName swiftkv_preload_rope_lut_Pipeline_preload_rope_lut_loop
set isTopModule 0
...
set C_modelName {swiftkv_preload_rope_lut_Pipeline_preload_rope_lut_loop}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem0 int 512 regular {axi_master 0}  }
	{ sext_ln1673 int 58 regular  }
	{ rope_lut int 608 regular {array 16384 { 0 } 0 1 } {global 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "model_bank0","offset": { "type": "dynamic","port_name": "model_bank0","bundle": "control"},"direction": "READONLY"},{"cName": "rope_lut_ddr","offset": { "type": "dynamic","port_name": "rope_lut_ddr","bundle": "control"},"direction": "READONLY"},{"cName": "residual_pe0","offset": { "type": "dynamic","port_name": "residual_pe0","bundle": "control"},"direction": "READWRITE"},{"cName": "logits_pe0","offset": { "type": "dynamic","port_name": "logits_pe0","bundle": "control"},"direction": "WRITEONLY"},{"cName": "kv_cache_pe0","offset": { "type": "dynamic","port_name": "kv_cache_pe0","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln1673", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "rope_lut", "interface" : "memory", "bitwidth" : 608, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ sext_ln1673 sc_in sc_lv 58 signal 1 } 
	{ rope_lut_address0 sc_out sc_lv 14 signal 2 } 
	{ rope_lut_ce0 sc_out sc_logic 1 signal 2 } 
	{ rope_lut_we0 sc_out sc_logic 1 signal 2 } 
	{ rope_lut_d0 sc_out sc_lv 608 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln1673", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln1673", "role": "default" }} , 
 	...
 	{ "name": "rope_lut_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rope_lut", "role": "we0" }} , 
 	{ "name": "rope_lut_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":608, "type": "signal", "bundle":{"name": "rope_lut", "role": "d0" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "swiftkv_preload_rope_lut_Pipeline_preload_rope_lut_loop",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "sext_ln1673", "Type" : "None", "Direction" : "I"},
			{"Name" : "rope_lut", "Type" : "Memory", "Direction" : "O"}],
		"Loop" : [
			{"Name" : "preload_rope_lut_loop", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "2", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage1", "LastStateIter" : "ap_enable_reg_pp0_iter1", "LastStateBlock" : "ap_block_pp0_stage1_subdone", "QuitState" : "ap_ST_fsm_pp0_stage1", "QuitStateIter" : "ap_enable_reg_pp0_iter1", "QuitStateBlock" : "ap_block_pp0_stage1_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	swiftkv_preload_rope_lut_Pipeline_preload_rope_lut_loop {
		gmem0 {Type I LastRead 2 FirstWrite -1}
		sext_ln1673 {Type I LastRead 0 FirstWrite -1}
		rope_lut {Type O LastRead -1 FirstWrite 3}}}
...
set Spec2ImplPortList { 
	...
	sext_ln1673 { ap_none {  { sext_ln1673 in_data 0 58 } } }
	rope_lut { ap_memory {  { rope_lut_address0 mem_address 1 14 }  { rope_lut_ce0 mem_ce 1 1 }  { rope_lut_we0 mem_we 1 1 }  { rope_lut_d0 mem_din 1 608 } } }
}
