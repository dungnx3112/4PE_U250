set moduleName int4_rms_normalize_quantize_pe_15_Pipeline_normalize_word_loop_normalize_lane_lo
set isTopModule 0
...
set C_modelName {int4_rms_normalize_quantize_pe.15_Pipeline_normalize_word_loop_normalize_lane_lo}
...
set C_modelArgList {
	...
	{ max_abs_bits_5_out int 32 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "empty", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "max_abs_bits_5_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ max_abs_bits_5_out sc_out sc_lv 32 signal 5 } 
	{ max_abs_bits_5_out_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ model_norm_cache3_address0 sc_out sc_lv 13 signal 6 } 
	{ model_norm_cache3_ce0 sc_out sc_logic 1 signal 6 } 
	{ model_norm_cache3_q0 sc_in sc_lv 512 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "max_abs_bits_5_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "max_abs_bits_5_out", "role": "default" }} , 
 	{ "name": "max_abs_bits_5_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "max_abs_bits_5_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fmul_32ns_32ns_32_4_max_dsp_1_U1387", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_33_4_32_1_1_U1388", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_33_4_32_1_1_U1389", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	max_abs_bits_5_out { ap_vld {  { max_abs_bits_5_out out_data 1 32 }  { max_abs_bits_5_out_ap_vld out_vld 1 1 } } }
	model_norm_cache3 { ap_memory {  { model_norm_cache3_address0 mem_address 1 13 }  { model_norm_cache3_ce0 mem_ce 1 1 }  { model_norm_cache3_q0 in_data 0 512 } } }
}
