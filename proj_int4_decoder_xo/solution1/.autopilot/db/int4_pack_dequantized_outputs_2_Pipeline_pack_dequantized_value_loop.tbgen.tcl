set moduleName int4_pack_dequantized_outputs_2_Pipeline_pack_dequantized_value_loop
set isTopModule 0
...
set C_modelName {int4_pack_dequantized_outputs.2_Pipeline_pack_dequantized_value_loop}
