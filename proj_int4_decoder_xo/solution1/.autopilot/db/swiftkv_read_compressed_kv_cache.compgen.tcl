...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_head_base \
    op interface \
    ports { head_base { I 24 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { cached_kv_word_stream_din { O 512 vector } cached_kv_word_stream_num_data_valid { I 7 vector } cached_kv_word_stream_fifo_cap { I 7 vector } cached_kv_word_stream_full_n { I 1 bit } cached_kv_word_stream_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 367 \
    name position_val_c14 \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_position_val_c14 \
    op interface \
    ports { position_val_c14_din { O 12 vector } position_val_c14_num_data_valid { I 3 vector } position_val_c14_fifo_cap { I 3 vector } position_val_c14_full_n { I 1 bit } position_val_c14_write { O 1 bit } } \
} "
}
