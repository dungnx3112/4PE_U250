set moduleName int4_swiglu_quantize_pe3_Pipeline_swiglu_quantize_reverse_loop
set isTopModule 0
...
set C_modelName {int4_swiglu_quantize_pe3_Pipeline_swiglu_quantize_reverse_loop}
set C_modelType { void 0 }
set C_modelArgList {
	{ swiglu_group float 32 regular {array 32 { 1 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "swiglu_group", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ swiglu_group_q0 sc_in sc_lv 32 signal 0 } 
	...
	{ grp_fu_134_p_opcode sc_out sc_lv 5 signal -1 } 
	{ grp_fu_134_p_dout0 sc_in sc_lv 1 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "swiglu_group_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "swiglu_group", "role": "q0" }} , 
 	...
 	{ "name": "grp_fu_134_p_opcode", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "grp_fu_134_p_opcode", "role": "default" }} , 
 	{ "name": "grp_fu_134_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_fu_134_p_dout0", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fcmp_32ns_32ns_1_2_no_dsp_1_U1049", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fcmp_32ns_32ns_1_2_no_dsp_1_U1050", "Parent" : "0"},
...
set Spec2ImplPortList { 
	swiglu_group { ap_memory {  { swiglu_group_address0 mem_address 1 5 }  { swiglu_group_ce0 mem_ce 1 1 }  { swiglu_group_q0 mem_dout 0 32 } } }
