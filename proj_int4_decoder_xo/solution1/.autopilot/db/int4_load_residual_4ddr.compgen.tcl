...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 63 \
    name residual_buffer0 \
    reset_level 1 \
    sync_rst true \
    dir O \
    corename residual_buffer0 \
    op interface \
    ports { residual_buffer0_address1 { O 6 vector } residual_buffer0_ce1 { O 1 bit } residual_buffer0_we1 { O 1 bit } residual_buffer0_d1 { O 512 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'residual_buffer0'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 64 \
    name residual_buffer1 \
    reset_level 1 \
    sync_rst true \
    dir O \
    corename residual_buffer1 \
    op interface \
    ports { residual_buffer1_address1 { O 6 vector } residual_buffer1_ce1 { O 1 bit } residual_buffer1_we1 { O 1 bit } residual_buffer1_d1 { O 512 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'residual_buffer1'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 65 \
    name residual_buffer2 \
    reset_level 1 \
    sync_rst true \
    dir O \
    corename residual_buffer2 \
    op interface \
    ports { residual_buffer2_address1 { O 6 vector } residual_buffer2_ce1 { O 1 bit } residual_buffer2_we1 { O 1 bit } residual_buffer2_d1 { O 512 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'residual_buffer2'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 66 \
    name residual_buffer3 \
    reset_level 1 \
    sync_rst true \
    dir O \
    corename residual_buffer3 \
    op interface \
    ports { residual_buffer3_address1 { O 6 vector } residual_buffer3_ce1 { O 1 bit } residual_buffer3_we1 { O 1 bit } residual_buffer3_d1 { O 512 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'residual_buffer3'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_residual_pe0 \
    op interface \
    ports { residual_pe0 { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_residual_pe1 \
    op interface \
    ports { residual_pe1 { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_residual_pe2 \
    op interface \
    ports { residual_pe2 { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_residual_pe3 \
    op interface \
    ports { residual_pe3 { I 64 vector } } \
} "
}
