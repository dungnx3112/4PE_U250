...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { weight_stream_din { O 512 vector } weight_stream_num_data_valid { I 15 vector } weight_stream_fifo_cap { I 15 vector } weight_stream_full_n { I 1 bit } weight_stream_write { O 1 bit } } \
} "
}
