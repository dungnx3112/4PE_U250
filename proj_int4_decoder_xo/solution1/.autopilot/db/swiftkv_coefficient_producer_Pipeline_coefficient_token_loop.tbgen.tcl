set moduleName swiftkv_coefficient_producer_Pipeline_coefficient_token_loop
set isTopModule 0
...
set C_modelName {swiftkv_coefficient_producer_Pipeline_coefficient_token_loop}
set C_modelType { void 0 }
set C_modelArgList {
	{ add_ln1094 int 13 regular  }
	{ score_stream int 32 regular {fifo 0 volatile }  }
	{ control_stream int 19 regular {fifo 1 volatile }  }
	{ normalization_out int 30 regular {pointer 1}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "add_ln1094", "interface" : "wire", "bitwidth" : 13, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "normalization_out", "interface" : "wire", "bitwidth" : 30, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ add_ln1094 sc_in sc_lv 13 signal 0 } 
	{ score_stream_dout sc_in sc_lv 32 signal 1 } 
	{ score_stream_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ score_stream_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ score_stream_empty_n sc_in sc_logic 1 signal 1 } 
	{ score_stream_read sc_out sc_logic 1 signal 1 } 
	...
	{ normalization_out sc_out sc_lv 30 signal 3 } 
	{ normalization_out_ap_vld sc_out sc_logic 1 outvld 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln1094", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "add_ln1094", "role": "default" }} , 
 	...
 	{ "name": "normalization_out", "direction": "out", "datatype": "sc_lv", "bitwidth":30, "type": "signal", "bundle":{"name": "normalization_out", "role": "default" }} , 
 	{ "name": "normalization_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "normalization_out", "role": "ap_vld" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.SWIFTKV_EXP2_LUT_Q30_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_12ns_44_2_1_U486", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_23ns_46_2_1_U487", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_30ns_18ns_48_5_1_U488", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "18", "Max" : "24588"}
	, {"Name" : "Interval", "Min" : "18", "Max" : "24588"}
]}
...
set Spec2ImplPortList { 
	add_ln1094 { ap_none {  { add_ln1094 in_data 0 13 } } }
	...
	normalization_out { ap_vld {  { normalization_out out_data 1 30 }  { normalization_out_ap_vld out_vld 1 1 } } }
}
