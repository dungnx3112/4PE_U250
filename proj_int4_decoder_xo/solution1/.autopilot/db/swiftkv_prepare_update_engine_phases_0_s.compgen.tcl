...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { engine0_control_stream_dout { I 59 vector } engine0_control_stream_num_data_valid { I 3 vector } engine0_control_stream_fifo_cap { I 3 vector } engine0_control_stream_empty_n { I 1 bit } engine0_control_stream_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { engine0_phase_stream_din { O 57 vector } engine0_phase_stream_num_data_valid { I 4 vector } engine0_phase_stream_fifo_cap { I 4 vector } engine0_phase_stream_full_n { I 1 bit } engine0_phase_stream_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 532 \
    name position_val_c32 \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_position_val_c32 \
    op interface \
    ports { position_val_c32_din { O 12 vector } position_val_c32_num_data_valid { I 3 vector } position_val_c32_fifo_cap { I 3 vector } position_val_c32_full_n { I 1 bit } position_val_c32_write { O 1 bit } } \
} "
}
