set moduleName int4_rms_normalize_quantize_pe_13_Pipeline_quantize_reverse_loop
set isTopModule 0
...
set C_modelName {int4_rms_normalize_quantize_pe.13_Pipeline_quantize_reverse_loop}
set C_modelType { void 0 }
set C_modelArgList {
	{ normalized float 32 regular {array 32 { 1 } 1 1 }  }
	{ inverse_scale float 32 regular  }
	{ quantized_word_07_out int 480 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "normalized", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "quantized_word_07_out", "interface" : "wire", "bitwidth" : 480, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ quantized_word_07_out sc_out sc_lv 480 signal 2 } 
	{ quantized_word_07_out_ap_vld sc_out sc_logic 1 outvld 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "quantized_word_07_out", "direction": "out", "datatype": "sc_lv", "bitwidth":480, "type": "signal", "bundle":{"name": "quantized_word_07_out", "role": "default" }} , 
 	{ "name": "quantized_word_07_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "quantized_word_07_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fadd_32ns_32ns_32_7_full_dsp_1_U1341", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fcmp_32ns_32ns_1_2_no_dsp_1_U1344", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fcmp_32ns_32ns_1_2_no_dsp_1_U1345", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	quantized_word_07_out { ap_vld {  { quantized_word_07_out out_data 1 480 }  { quantized_word_07_out_ap_vld out_vld 1 1 } } }
}
