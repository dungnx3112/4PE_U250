set moduleName swiftkv_read_compressed_kv_cache
set isTopModule 0
...
set C_modelName {swiftkv_read_compressed_kv_cache}
...
set C_modelArgList {
	...
	{ position_val_c14 int 12 regular {fifo 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "model_bank0","offset": { "type": "dynamic","port_name": "model_bank0","bundle": "control"},"direction": "READONLY"},{"cName": "rope_lut_ddr","offset": { "type": "dynamic","port_name": "rope_lut_ddr","bundle": "control"},"direction": "READONLY"},{"cName": "residual_pe0","offset": { "type": "dynamic","port_name": "residual_pe0","bundle": "control"},"direction": "READWRITE"},{"cName": "logits_pe0","offset": { "type": "dynamic","port_name": "logits_pe0","bundle": "control"},"direction": "WRITEONLY"},{"cName": "kv_cache_pe0","offset": { "type": "dynamic","port_name": "kv_cache_pe0","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "position_val_c14", "interface" : "fifo", "bitwidth" : 12, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ kv_cache sc_in sc_lv 64 signal 1 } 
	{ head_base sc_in sc_lv 24 signal 2 } 
	{ position sc_in sc_lv 12 signal 3 } 
	{ cached_kv_word_stream_din sc_out sc_lv 512 signal 4 } 
	{ cached_kv_word_stream_num_data_valid sc_in sc_lv 7 signal 4 } 
	{ cached_kv_word_stream_fifo_cap sc_in sc_lv 7 signal 4 } 
	{ cached_kv_word_stream_full_n sc_in sc_logic 1 signal 4 } 
	{ cached_kv_word_stream_write sc_out sc_logic 1 signal 4 } 
	{ position_val_c14_din sc_out sc_lv 12 signal 5 } 
	{ position_val_c14_num_data_valid sc_in sc_lv 3 signal 5 } 
	{ position_val_c14_fifo_cap sc_in sc_lv 3 signal 5 } 
	{ position_val_c14_full_n sc_in sc_logic 1 signal 5 } 
	{ position_val_c14_write sc_out sc_logic 1 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "position_val_c14_din", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "position_val_c14", "role": "din" }} , 
 	{ "name": "position_val_c14_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "position_val_c14", "role": "num_data_valid" }} , 
 	{ "name": "position_val_c14_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "position_val_c14", "role": "fifo_cap" }} , 
 	{ "name": "position_val_c14_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "position_val_c14", "role": "full_n" }} , 
 	{ "name": "position_val_c14_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "position_val_c14", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_swiftkv_read_compressed_kv_cache_Pipeline_read_compressed_kv_loop_fu_114", "Port" : "gmem0", "Inst_start_state" : "73", "Inst_end_state" : "74"}]},
			{"Name" : "kv_cache", "Type" : "None", "Direction" : "I"},
			{"Name" : "head_base", "Type" : "None", "Direction" : "I"},
			{"Name" : "position", "Type" : "None", "Direction" : "I"},
			{"Name" : "cached_kv_word_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_swiftkv_read_compressed_kv_cache_Pipeline_read_compressed_kv_loop_fu_114", "Port" : "cached_kv_word_stream", "Inst_start_state" : "73", "Inst_end_state" : "74"}]},
			{"Name" : "position_val_c14", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "position_val_c14_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_swiftkv_read_compressed_kv_cache_Pipeline_read_compressed_kv_loop_fu_114", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_swiftkv_read_compressed_kv_cache_Pipeline_read_compressed_kv_loop_fu_114.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "75", "Max" : "20551"}
	, {"Name" : "Interval", "Min" : "75", "Max" : "20551"}
]}
...
set Spec2ImplPortList { 
	...
	head_base { ap_none {  { head_base in_data 0 24 } } }
	...
	position_val_c14 { ap_fifo {  { position_val_c14_din fifo_data_in 1 12 }  { position_val_c14_num_data_valid fifo_status_num_data_valid 0 3 }  { position_val_c14_fifo_cap fifo_update 0 3 }  { position_val_c14_full_n fifo_status 0 1 }  { position_val_c14_write fifo_port_we 1 1 } } }
}
