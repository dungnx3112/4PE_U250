set moduleName swiftkv_update_value_engine_Pipeline_initialize_weighted_value_engine_phase_loop_3
set isTopModule 0
...
set C_modelName {swiftkv_update_value_engine_Pipeline_initialize_weighted_value_engine_phase_loop.3}
