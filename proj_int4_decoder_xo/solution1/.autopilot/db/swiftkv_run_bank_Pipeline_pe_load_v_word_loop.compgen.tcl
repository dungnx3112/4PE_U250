...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename v_words \
    op interface \
    ports { v_words_address0 { O 3 vector } v_words_ce0 { O 1 bit } v_words_we0 { O 1 bit } v_words_d0 { O 512 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'v_words'"
}
}
