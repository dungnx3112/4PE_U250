set moduleName int4_rms_sumsq_pe_12_Pipeline_merge_sumsq_lane_loop
set isTopModule 0
...
set C_modelName {int4_rms_sumsq_pe.12_Pipeline_merge_sumsq_lane_loop}
...
set C_modelArgList {
	...
	{ merged_out float 32 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "mux_case_02_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "merged_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ merged_out sc_out sc_lv 32 signal 16 } 
	{ merged_out_ap_vld sc_out sc_logic 1 outvld 16 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "merged_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "merged_out", "role": "default" }} , 
 	{ "name": "merged_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "merged_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_33_4_32_1_1_U1263", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	merged_out { ap_vld {  { merged_out out_data 1 32 }  { merged_out_ap_vld out_vld 1 1 } } }
}
