set moduleName int4_run_pe_dataflow_1_Block_entry2_proc21
set isTopModule 0
...
set C_modelName {int4_run_pe_dataflow<1>_Block_entry2_proc21}
...
set portList { 
	...
	{ linear_command_pe1_dout sc_in sc_lv 14 signal 0 } 
	{ linear_command_pe1_num_data_valid sc_in sc_lv 3 signal 0 } 
	{ linear_command_pe1_fifo_cap sc_in sc_lv 3 signal 0 } 
	{ linear_command_pe1_empty_n sc_in sc_logic 1 signal 0 } 
	{ linear_command_pe1_read sc_out sc_logic 1 signal 0 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_6ns_6ns_12_1_1_U1843", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	linear_command_pe1 { ap_fifo {  { linear_command_pe1_dout fifo_data_in 0 14 }  { linear_command_pe1_num_data_valid fifo_status_num_data_valid 0 3 }  { linear_command_pe1_fifo_cap fifo_update 0 3 }  { linear_command_pe1_empty_n fifo_status 0 1 }  { linear_command_pe1_read fifo_port_we 1 1 } } }
}
