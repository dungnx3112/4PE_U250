set moduleName swiftkv_update_value_engine_1_s
set isTopModule 0
...
set C_modelName {swiftkv_update_value_engine<1>}
set C_modelType { void 0 }
set C_modelArgList {
	{ engine1_phase_stream int 57 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "engine1_phase_stream", "interface" : "fifo", "bitwidth" : 57, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ engine1_phase_stream_dout sc_in sc_lv 57 signal 0 } 
	{ engine1_phase_stream_num_data_valid sc_in sc_lv 4 signal 0 } 
	{ engine1_phase_stream_fifo_cap sc_in sc_lv 4 signal 0 } 
	{ engine1_phase_stream_empty_n sc_in sc_logic 1 signal 0 } 
	{ engine1_phase_stream_read sc_out sc_logic 1 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "engine1_phase_stream_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":57, "type": "signal", "bundle":{"name": "engine1_phase_stream", "role": "dout" }} , 
 	...
 	{ "name": "engine1_phase_stream_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "engine1_phase_stream", "role": "empty_n" }} , 
 	{ "name": "engine1_phase_stream_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "engine1_phase_stream", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "engine1_phase_stream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "8", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_swiftkv_update_value_engine_1_Pipeline_update_value_engine_phase_loop_fu_76", "Port" : "engine1_phase_stream", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			...
			{"Name" : "weighted_value_0", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_swiftkv_update_value_engine_Pipeline_initialize_weighted_value_engine_phase_loop_2_fu_64", "Port" : "weighted_value_0", "Inst_start_state" : "1", "Inst_end_state" : "2"},
					{"ID" : "3", "SubInstance" : "grp_swiftkv_update_value_engine_1_Pipeline_update_value_engine_phase_loop_fu_76", "Port" : "weighted_value_0", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "weighted_value_1", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_swiftkv_update_value_engine_Pipeline_initialize_weighted_value_engine_phase_loop_2_fu_64", "Port" : "weighted_value_1", "Inst_start_state" : "1", "Inst_end_state" : "2"},
					{"ID" : "3", "SubInstance" : "grp_swiftkv_update_value_engine_1_Pipeline_update_value_engine_phase_loop_fu_76", "Port" : "weighted_value_1", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "weighted_value_2", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_swiftkv_update_value_engine_Pipeline_initialize_weighted_value_engine_phase_loop_2_fu_64", "Port" : "weighted_value_2", "Inst_start_state" : "1", "Inst_end_state" : "2"},
					{"ID" : "3", "SubInstance" : "grp_swiftkv_update_value_engine_1_Pipeline_update_value_engine_phase_loop_fu_76", "Port" : "weighted_value_2", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "weighted_value_3", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_swiftkv_update_value_engine_Pipeline_initialize_weighted_value_engine_phase_loop_2_fu_64", "Port" : "weighted_value_3", "Inst_start_state" : "1", "Inst_end_state" : "2"},
					{"ID" : "3", "SubInstance" : "grp_swiftkv_update_value_engine_1_Pipeline_update_value_engine_phase_loop_fu_76", "Port" : "weighted_value_3", "Inst_start_state" : "3", "Inst_end_state" : "4"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_swiftkv_update_value_engine_Pipeline_initialize_weighted_value_engine_phase_loop_2_fu_64", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_swiftkv_update_value_engine_Pipeline_initialize_weighted_value_engine_phase_loop_2_fu_64.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_swiftkv_update_value_engine_1_Pipeline_update_value_engine_phase_loop_fu_76", "Parent" : "0", "Child" : ["4", "5", "6", "7", "8"],
	...
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_swiftkv_update_value_engine_1_Pipeline_update_value_engine_phase_loop_fu_76.mul_32s_18ns_50_5_1_U594", "Parent" : "3"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_swiftkv_update_value_engine_1_Pipeline_update_value_engine_phase_loop_fu_76.mul_32s_18ns_50_5_1_U595", "Parent" : "3"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_swiftkv_update_value_engine_1_Pipeline_update_value_engine_phase_loop_fu_76.mul_32s_18ns_50_5_1_U596", "Parent" : "3"},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_swiftkv_update_value_engine_1_Pipeline_update_value_engine_phase_loop_fu_76.mul_32s_18ns_50_5_1_U597", "Parent" : "3"},
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_swiftkv_update_value_engine_1_Pipeline_update_value_engine_phase_loop_fu_76.flow_control_loop_pipe_sequential_init_U", "Parent" : "3"}]}
...
set Spec2ImplPortList { 
	engine1_phase_stream { ap_fifo {  { engine1_phase_stream_dout fifo_data_in 0 57 }  { engine1_phase_stream_num_data_valid fifo_status_num_data_valid 0 4 }  { engine1_phase_stream_fifo_cap fifo_update 0 4 }  { engine1_phase_stream_empty_n fifo_status 0 1 }  { engine1_phase_stream_read fifo_port_we 1 1 } } }
