set moduleName swiftkv_prepare_update_engine_phases_3_s
set isTopModule 0
...
set C_modelName {swiftkv_prepare_update_engine_phases<3>}
...
set portList { 
	...
	{ engine3_control_stream_dout sc_in sc_lv 59 signal 0 } 
	{ engine3_control_stream_num_data_valid sc_in sc_lv 3 signal 0 } 
	{ engine3_control_stream_fifo_cap sc_in sc_lv 3 signal 0 } 
	{ engine3_control_stream_empty_n sc_in sc_logic 1 signal 0 } 
	{ engine3_control_stream_read sc_out sc_logic 1 signal 0 } 
	{ value0_engine3_stream_dout sc_in sc_lv 128 signal 1 } 
	{ value0_engine3_stream_num_data_valid sc_in sc_lv 6 signal 1 } 
	{ value0_engine3_stream_fifo_cap sc_in sc_lv 6 signal 1 } 
	{ value0_engine3_stream_empty_n sc_in sc_logic 1 signal 1 } 
	{ value0_engine3_stream_read sc_out sc_logic 1 signal 1 } 
	{ value1_engine3_stream_dout sc_in sc_lv 128 signal 2 } 
	{ value1_engine3_stream_num_data_valid sc_in sc_lv 6 signal 2 } 
	{ value1_engine3_stream_fifo_cap sc_in sc_lv 6 signal 2 } 
	{ value1_engine3_stream_empty_n sc_in sc_logic 1 signal 2 } 
	{ value1_engine3_stream_read sc_out sc_logic 1 signal 2 } 
	...
	{ engine3_phase_stream_din sc_out sc_lv 57 signal 4 } 
	{ engine3_phase_stream_num_data_valid sc_in sc_lv 4 signal 4 } 
	{ engine3_phase_stream_fifo_cap sc_in sc_lv 4 signal 4 } 
	{ engine3_phase_stream_full_n sc_in sc_logic 1 signal 4 } 
	{ engine3_phase_stream_write sc_out sc_logic 1 signal 4 } 
	{ position_val_c_din sc_out sc_lv 12 signal 5 } 
	{ position_val_c_num_data_valid sc_in sc_lv 3 signal 5 } 
	{ position_val_c_fifo_cap sc_in sc_lv 3 signal 5 } 
	{ position_val_c_full_n sc_in sc_logic 1 signal 5 } 
	{ position_val_c_write sc_out sc_logic 1 signal 5 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "engine3_control_stream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_swiftkv_prepare_update_engine_phases_Pipeline_prepare_update_engine_phase_loop_fu_70", "Port" : "engine3_control_stream", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "value0_engine3_stream", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_swiftkv_prepare_update_engine_phases_Pipeline_prepare_update_engine_phase_loop_fu_70", "Port" : "value0_engine3_stream", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "value1_engine3_stream", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_swiftkv_prepare_update_engine_phases_Pipeline_prepare_update_engine_phase_loop_fu_70", "Port" : "value1_engine3_stream", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			...
			{"Name" : "engine3_phase_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "8", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_swiftkv_prepare_update_engine_phases_Pipeline_prepare_update_engine_phase_loop_fu_70", "Port" : "engine3_phase_stream", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_swiftkv_prepare_update_engine_phases_Pipeline_prepare_update_engine_phase_loop_fu_70", "Parent" : "0", "Child" : ["2", "3"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_swiftkv_prepare_update_engine_phases_Pipeline_prepare_update_engine_phase_loop_fu_70.sparsemux_9_2_5_1_1_U557", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_swiftkv_prepare_update_engine_phases_Pipeline_prepare_update_engine_phase_loop_fu_70.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
