...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename normalized \
    op interface \
    ports { normalized_address0 { O 5 vector } normalized_ce0 { O 1 bit } normalized_we0 { O 1 bit } normalized_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'normalized'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { reciprocal_rms { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 1311 \
    name max_abs_bits_8_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_max_abs_bits_8_out \
    op interface \
    ports { max_abs_bits_8_out { O 32 vector } max_abs_bits_8_out_ap_vld { O 1 bit } } \
} "
}
