...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename output_mem \
    op interface \
    ports { output_mem_address0 { O 9 vector } output_mem_ce0 { O 1 bit } output_mem_q0 { I 512 vector } output_mem_address1 { O 9 vector } output_mem_ce1 { O 1 bit } output_mem_we1 { O 1 bit } output_mem_d1 { O 512 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { output_stream_dout { I 512 vector } output_stream_num_data_valid { I 5 vector } output_stream_fifo_cap { I 5 vector } output_stream_empty_n { I 1 bit } output_stream_read { O 1 bit } } \
} "
}
