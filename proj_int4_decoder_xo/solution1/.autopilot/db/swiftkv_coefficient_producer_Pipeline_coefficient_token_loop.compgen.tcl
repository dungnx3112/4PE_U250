...
set name int4_decoder_token_controller_mul_32ns_12ns_44_2_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 1 ALLOW_PRAGMA 1
}


set name int4_decoder_token_controller_mul_32s_23ns_46_2_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 1 ALLOW_PRAGMA 1
}


set name int4_decoder_token_controller_mul_30ns_18ns_48_5_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler int4_decoder_token_controller_swiftkv_coefficient_producer_Pipeline_coefficient_token_loop_SWIFTKV_EXP2_LUTbkb BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_ln1094 \
    op interface \
    ports { add_ln1094 { I 13 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 496 \
    name normalization_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_normalization_out \
    op interface \
    ports { normalization_out { O 30 vector } normalization_out_ap_vld { O 1 bit } } \
} "
}
