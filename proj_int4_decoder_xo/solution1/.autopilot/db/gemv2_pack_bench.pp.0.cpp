...
# 2 "<built-in>" 2
# 1 "source/gemv2_pack_bench.cpp" 2
# 1 "source/gemv2_pack_bench.hpp" 1
...
# 4 "source/gemv2_pack_bench.hpp" 2
...
# 5 "source/gemv2_pack_bench.hpp" 2
...
# 2 "source/gemv2_pack_bench.cpp" 2
# 27 "source/gemv2_pack_bench.cpp"
static constexpr int PACK_GAP = 23;
# 43 "source/gemv2_pack_bench.cpp"
...
# 82 "source/gemv2_pack_bench.cpp"
...
# 119 "source/gemv2_pack_bench.cpp"
void gemv2_base_g32(
    hls::stream<act15_t>& x_s,
    hls::stream<w4_t>& w0_s,
    hls::stream<w4_t>& w1_s,
...
# 168 "source/gemv2_pack_bench.cpp"
void gemv2_pack_g32(
    hls::stream<act15_t>& x_s,
    hls::stream<w4_t>& w0_s,
    hls::stream<w4_t>& w1_s,
...
#pragma HLS PIPELINE II=1
 ...
 act15_t x = x_s.read();
        ...
        ap_int<27> packed_w =
            pack_two_w4(w0, w1);
# 205 "source/gemv2_pack_bench.cpp"
...
# 229 "source/gemv2_pack_bench.cpp"
void gemv2_base_g64(
    hls::stream<act15_t>& x_s,
    hls::stream<w4_t>& w0_s,
    hls::stream<w4_t>& w1_s,
...
# 283 "source/gemv2_pack_bench.cpp"
void gemv2_pack_g64(
    hls::stream<act15_t>& x_s,
    hls::stream<w4_t>& w0_s,
    hls::stream<w4_t>& w1_s,
