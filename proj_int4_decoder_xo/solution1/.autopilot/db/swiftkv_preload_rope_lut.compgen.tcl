...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename rope_lut \
    op interface \
    ports { rope_lut_address0 { O 14 vector } rope_lut_ce0 { O 1 bit } rope_lut_we0 { O 1 bit } rope_lut_d0 { O 608 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'rope_lut'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_rope_lut_ddr \
    op interface \
    ports { rope_lut_ddr { I 64 vector } } \
} "
}
