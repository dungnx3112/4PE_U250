...
module int4_decoder_token_controller_int4_store_residual_4ddr_Pipeline_store_residual_word_loop (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [57:0] sext_ln498;
input  [57:0] sext_ln498_1;
input  [57:0] sext_ln498_2;
input  [57:0] sext_ln498_3;
...
reg   [511:0] residual_buffer0_load_reg_322;
reg   [511:0] residual_buffer1_load_reg_327;
reg   [511:0] residual_buffer2_load_reg_332;
reg   [511:0] residual_buffer3_load_reg_337;
wire   [63:0] zext_ln499_fu_234_p1;
wire    ap_block_pp0_stage0_01001;
reg   [6:0] word_fu_86;
wire   [6:0] add_ln500_fu_228_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_word_16;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln499_fu_222_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln499_fu_222_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln500_fu_228_p2 = (ap_sig_allocacmp_word_16 + 7'd1);
...
always @ (*) begin
    ap_block_state3_io = ((m_axi_gmem0_WREADY == 1'b0) | (m_axi_gmem3_WREADY == 1'b0) | (m_axi_gmem2_WREADY == 1'b0) | (m_axi_gmem1_WREADY == 1'b0));
end
...
assign icmp_ln499_fu_222_p2 = ((ap_sig_allocacmp_word_16 == 7'd64) ? 1'b1 : 1'b0);
...
assign m_axi_gmem0_WDATA = residual_buffer0_load_reg_322;
...
assign m_axi_gmem1_WDATA = residual_buffer1_load_reg_327;
...
assign m_axi_gmem2_WDATA = residual_buffer2_load_reg_332;
...
assign m_axi_gmem3_WDATA = residual_buffer3_load_reg_337;
...
assign residual_buffer0_address0 = zext_ln499_fu_234_p1;

assign residual_buffer1_address0 = zext_ln499_fu_234_p1;

assign residual_buffer2_address0 = zext_ln499_fu_234_p1;

assign residual_buffer3_address0 = zext_ln499_fu_234_p1;

assign zext_ln499_fu_234_p1 = ap_sig_allocacmp_word_16;

endmodule //int4_decoder_token_controller_int4_store_residual_4ddr_Pipeline_store_residual_word_loop
