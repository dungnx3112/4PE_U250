...
# Final implementation target: 300 MHz.  Keep this value identical to the
# v++ --freqhz setting and to link_300mhz.cfg; the routed timing gate checks
# the generated kernel clock again before publishing the XCLBIN.
