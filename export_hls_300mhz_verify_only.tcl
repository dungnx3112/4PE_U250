...
if {![file exists $patch_script]} { error "Missing patch: $patch_script" }
source $patch_script

set rtl_gate_script [file normalize "verify_generated_rtl_300mhz.tcl"]
if {![file exists $rtl_gate_script]} { error "Missing gate: $rtl_gate_script" }
...
if {![file exists $checksum_script]} { error "Missing checksum: $checksum_script" }
