...
#pragma HLS STABLE variable=kv_cache
    ...
    hls::stream<float> rms_partial1("pe1_rms_partial1");
    hls::stream<float> rms_sum23("pe1_rms_sum23");
    hls::stream<float> rms_reciprocal0("pe1_rms_reciprocal0");
    hls::stream<float> rms_reciprocal1("pe1_rms_reciprocal1");
    hls::stream<float> rms_reciprocal23("pe1_rms_reciprocal23");
    hls::stream<int4_reduction_packet_t> linear_partial0("pe1_linear_partial0");
    hls::stream<int4_reduction_packet_t> linear_partial1("pe1_linear_partial1");
    hls::stream<int4_reduction_packet_t> linear_sum01_local("pe1_linear_sum01_local");
    hls::stream<int4_reduction_packet_t> linear_sum01_remote("pe1_linear_sum01_remote");
...
#pragma HLS BIND_STORAGE variable=linear_output0 type=fifo impl=bram
    ...
    int4_relay_rms_schedule<10>(
        rms_partial_from_pe0, rms_partial0);
    int4_relay_rms_schedule<11>(
        rms_reciprocal0, rms_reciprocal_to_pe0);
    int4_relay_rms_schedule<12>(
        rms_sum_from_pe2, rms_sum23);
    int4_relay_rms_schedule<13>(
...
#pragma HLS STABLE variable=kv_cache
    ...
    hls::stream<float> rms_partial3("pe2_rms_partial3");
    hls::stream<float> rms_reciprocal2("pe2_rms_reciprocal2");
    hls::stream<float> rms_reciprocal3("pe2_rms_reciprocal3");
    hls::stream<float> rms_sum23("pe2_rms_sum23");
    hls::stream<float> rms_reciprocal01("pe2_rms_reciprocal01");
    hls::stream<int4_reduction_packet_t> linear_partial2("pe2_linear_partial2");
    hls::stream<int4_reduction_packet_t> linear_partial3("pe2_linear_partial3");
    hls::stream<int4_reduction_packet_t> linear_sum23_local("pe2_linear_sum23_local");
    hls::stream<int4_reduction_packet_t> linear_sum23_remote("pe2_linear_sum23_remote");
...
#pragma HLS BIND_STORAGE variable=linear_output3 type=fifo impl=bram
    ...
    int4_relay_rms_schedule<20>(
        rms_reciprocal_from_pe1, rms_reciprocal01);
    int4_relay_rms_schedule<21>(
        rms_sum23, rms_sum_to_pe1);
    int4_relay_rms_schedule<22>(
        rms_partial_from_pe3, rms_partial3);
    int4_relay_rms_schedule<23>(
